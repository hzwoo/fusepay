/**
 * lib/modules/channel/alipay/trade-create.js
 */
...
class TradeCreate extends AlipayResource {
  constructor(client) {
    super(client);
    ...
    this.extendParams = {
      biz_content: [
        ...
        'total_amount:9',
        'optional!discountable_amount:9',
        'optional!undiscountable_amount:9',
        'optional!buyer_logon_id:100',
        'subject:256',
        'optional!body:128',
        'either![buyer_id:28|buyer_logon_id]',
